  ...
  return (
    <div className="relative mx-auto mt-10 flex w-fit">
        ...
        <div className="-top-5 z-10">
          ...
          <PurpleDots className="-translate-y-1 translate-x-157" />
          ...
          <div className="absolute inset-y-1/6 shadow-md -right-1/14 flex h-20 w-20 items-center justify-center rounded-2xl border-2 border-neutral-400 bg-neutral-100">
            <Eyes />
          </div>
          <PurpleDots className="translate-y-28 translate-x-172" />
          <div className="absolute right-6 -bottom-1/4 h-16 w-16 p-1 bg-white shadow-sm rounded-2xl overflow-hidden">
            <Image src={"/images/rightPic2.png"} className="h-full w-full" alt="rightPic" width={1000} height={1000} />
          </div>
        </div>
      </div>
  )
